 ...
 *
 */
@Stateless(name = ITimer.EJB_REF_ELABORATORE_ASINCORNO_CERT )
public class ElaborazioneAsincronaDownloadTimerCert extends AbstractTimer implements ITimer {
	 ...
	 * 
	 */
	public ElaborazioneAsincronaDownloadTimerCert() { super(); }
