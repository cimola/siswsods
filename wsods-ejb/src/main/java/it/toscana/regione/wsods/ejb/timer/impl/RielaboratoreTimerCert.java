 ...
 *
 */
@Stateless(name = ITimer.EJB_REF_RIELABORATORE_CERT )
public class RielaboratoreTimerCert extends AbstractTimer implements ITimer{
	...
	public RielaboratoreTimerCert() { super(); }
	...
	protected void execute(final Timer timer,final InfoTimer infoTimer ) {
		...
		managerRielaboratore.rielaborarecordCert(numeroTimer,discriminante);
	}
}
