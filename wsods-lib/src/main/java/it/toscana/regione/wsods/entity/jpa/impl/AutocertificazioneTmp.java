 ...
 */
@Entity
@Table(name = "AUTOCERTIFICAZIONE_TMP")
public class AutocertificazioneTmp extends DbEntity implements IAutocertificazioneTmp {
	...
	public AutocertificazioneTmp() { super(); }
	
	public AutocertificazioneTmp(final IAutocertificazioneScartate entity) {
		super();
