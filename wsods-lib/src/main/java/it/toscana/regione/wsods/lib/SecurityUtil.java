...
//	
//	/*
//	 final KeyStore trustStore = SecurityTool.loadKeyStore(jks_path, "JKS", jks_pwd.toCharArray());
//			final KeyStore keyStore = SecurityTool.loadKeyStore(jks_path, "JKS", jks_pwd.toCharArray());
//			if (alias != null && alias.trim().length()>0 ){
//				try {
//					if(keyStore.containsAlias(alias)){
//						final Enumeration<String>  enume = keyStore.aliases();
//						while (enume.hasMoreElements()){
//							final String curr = enume.nextElement();
//							if( curr!= null){
//								if (!curr.equalsIgnoreCase(alias)&& keyStore.isKeyEntry(curr)){
//									keyStore.deleteEntry(curr);
//								}
//							}
//						}
//						
...
//					throw new WsToolRuntimeException(ExceptionType.CONFIGURAZIONE_INADEGUATA, "imossibile selezionare alias "+alias+"");
//				}
//			}
//			sslSocketFactory = SecurityTool.createSSLSocketFactory(url, trustStore, keyStore, jks_pwd.toCharArray());
//	 */
...
//		return loadKeyStore(pathFile, certType, storepass, null);
//	}
//	public static KeyStore loadKeyStore(final String pathFile, final String certType, final char[] storepass,final String alias) throws SecurityException  {
//
...
//
//		try {
//			fis = new FileInputStream(pathFile.trim());
//			final KeyStore keyStore = KeyStore.getInstance(certType.trim());
//			keyStore.load(fis, storepass);
//			selectAliasKey(alias, keyStore);
//			return keyStore;
...
//		}
//	}
//	private static void selectAliasKey(final String alias, final KeyStore keyStore) throws SecurityException {
//		if (alias != null && alias.trim().length()>0 ){
//			try {
//				if(keyStore.containsAlias(alias)){
//					final Enumeration<String>  enume = keyStore.aliases();
...
//				}
//			}catch (KeyStoreException e ){
//				throw new SecurityException(Code.SECURE_KEY_STORE, "imossibile selezionare alias "+alias+"");
//			}
//		}
//	}
//	
